    ...
    <div id="status-banner-section" className="mb-8">
      ...
      <div id="metrics-summary-grid" className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-4">
        ...
        <div
          ...
          className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs cursor-pointer hover:border-emerald-300 dark:hover:border-emerald-700/60 hover:shadow-sm transition-all group"
          title="点击切换至微服务监控卡片"
        >
        ...
        <div
          ...
          className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs cursor-pointer hover:border-sky-300 dark:hover:border-sky-700/60 hover:shadow-sm transition-all group"
          title="点击切换至服务器节点卡片"
        >
          <div className="flex items-center justify-between text-xs font-medium text-slate-500 dark:text-slate-400 mb-1">
        ...
        <div
          ...
          className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs cursor-pointer hover:border-amber-300 dark:hover:border-amber-700/60 hover:shadow-sm transition-all group"
        ...
        <div
          onClick={onNavigateToTelegram}
          className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs cursor-pointer hover:border-sky-300 dark:hover:border-sky-800 hover:shadow-sm transition-all group"
